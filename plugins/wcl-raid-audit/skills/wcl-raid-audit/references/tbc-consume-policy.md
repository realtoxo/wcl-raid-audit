...
- During report generation, repeated network requests are cached in memory, persisted to a local SQLite cache across runs, and 429 rate limits are retried with exponential backoff.
